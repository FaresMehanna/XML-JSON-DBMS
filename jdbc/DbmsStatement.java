...
public class DbmsStatement implements java.sql.Statement{
	...
	public void addBatch(String arg0) throws SQLException {
		if(isClose == true) throw new SQLException("Error statement has been closed ..");
		queries.add(arg0);
	}
	...
	public ResultSet getResultSet() throws SQLException {
		if(isClose == true) throw new RuntimeException("Error statement has been closed ..");
		if(rset == null)    throw new SQLException("GetResultSet must be used only one time");
		resultset temp = rset;
		rset = null;
		return temp;
	}
